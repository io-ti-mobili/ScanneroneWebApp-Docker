...
public interface WifiNetworkRepository extends JpaRepository<WifiNetwork, Long> {
        ...
        List<Object[]> findTopCitiesByNetworkCountFiltered(@Param("country") String country,
        ...
        List<Object[]> findTopCitiesByWpa3CountFiltered(@Param("country") String country,
                        @Param("region") String region,
                        @Param("limit") int limit);
        ...
        @Query(value = """
                            ...
                            ORDER BY openRatio DESC LIMIT :limit
                        """, nativeQuery = true)
        List<Object[]> findTopCitiesByOpenRatioFiltered(@Param("country") String country,
                        @Param("region") String region,
                        @Param("limit") int limit);
